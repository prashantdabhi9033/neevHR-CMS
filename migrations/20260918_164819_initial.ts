...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_posts_category" AS ENUM('payroll', 'compliance', 'time', 'performance', 'recruitment', 'hr-strategy', 'product');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('payroll', 'compliance', 'time', 'performance', 'recruitment', 'hr-strategy', 'product');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_leads_size" AS ENUM('500 - 1,000', '1,000 - 2,500', '2,500 - 5,000', 'Other');
  ...
  CREATE TABLE "posts" (
  	...
  	"slug" varchar,
  	"excerpt" varchar,
  	"category" "enum_posts_category" DEFAULT 'hr-strategy',
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_category" "enum__posts_v_version_category" DEFAULT 'hr-strategy',
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_leads_size";
